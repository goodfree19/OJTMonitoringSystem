...
if (isset($_POST['search_btn'])) {
    ...
    $items = "SELECT * FROM users WHERE Fname LIKE '%$search_query%' OR Lname LIKE '%$search_query%' OR ID_student LIKE '%$search_query%' ";
} else {
    $items = "SELECT * FROM users WHERE archive=0";
}
            ...
            <div id="page_top" class="section-body top_dark">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title"><i class="fa fa-user"></i> Student</h1>
                        </div>
                                    ...
                                    <div class="d-md-flex justify-content-between mb-2">
                                        <ul class="nav nav-tabs b-none">
                                            <li class="nav-item"><a class="nav-link active" 
                                                    href="#"><i class="fa fa-list-ul"> </i> Students List</a>
                                            </li>
                                           
                                        </ul>
                                    </div>
                                    <form action="code.php" class="text-center" method="POST">
                                    <button id="archiveAllStudents" name="btn_archive" class="btn m-3 btn-danger">Archive All Student</button> <br>
                                    <a href="view_archive_student.php"> View All Archive</a>
                                    </form>
