                    ...
                    
                                                    {
                                                        ...
                                                        <div class="card-body">
                                                                            ...
                                                                            <h5 class="">
                                                                                ...
                                                                                if (mysqli_num_rows($items_run) > 0) {
                                                                                    foreach ($items_run as $item_q) {
                                                                                        echo $name_student=$item_q['Fname'] . " " . $item_q['Lname'];
                                                                                        $id = $item_q['id'];
                                                                                    }
                                                                                }
                                                            ...
                                                            <?php
                                                                ...
                                                                $narativeee= $item['narative_report'];
                                                                $id_dowload=$item['id'];
                                                                    $myid=$id_dowload;
                                                                            ...
                                                                            foreach ($items_run as $item) {
                                                                                ...
                                                                                if(mysqli_num_rows($items_run)>0){
                                                                                    foreach ($items_run as $item_ko) {
                                                                                        ...
                                                                                        //for geting the name of the studne
                                                                             $name=$item_ko['user_id'];
                                                                             
                                                                                        $date_narative=$item_ko['date'];
                                                                            
                                                                                $section->addText("Student Name: {$name_student}");
                                                                                $section->addText("Date: {$date_narative}");
                                                                                $section->addText("Total Hours:  {$total_hours}");
                                                                                $section->addText("Tasks Accomplished", ['size' => 14, 'bold' => true]);
                                                                                $section->addText($narativeee);
                                                                                ...
                                                                                $fileName = "NARATIVE_DOC/{$name_student}_{$item['date']}.docx";
                                                                                $objWriter = IOFactory::createWriter($phpWord, 'Word2007');
                                                                                $objWriter->save($fileName);
        
                                                                                // Provide download link
                                                                                echo "<a href='$fileName' download>Download Document for {$name_student} on {$date_narative}</a>";
