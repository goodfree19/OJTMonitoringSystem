...
?>
  ...
  <div class="container-fluid h-custom p6 align-items-center mt-5">
  <?php include('include/message.php');?>
      ...
      <div class="form-outline text-center bg-success rounded text-white mb-3"><label class="form-label fs-2 text-center " for="form3Example3">OJT Monitoring System</label></div>
          ...
          <div class="form-outline mb-4">
            <input required type="text" require name="ID_number" id="form3Example3" class="form-control form-control-lg"
          ...
          <div class="form-outline mb-3">
            <input required type="password" name="password" id="form3Example4" class="form-control form-control-lg" placeholder="Enter password" />
      ...
      <input class="form-check-input me-2" type="checkbox" id="showPasswordCheckbox"> Show password
            ...
            <a href="resetpassword_student.php" class="text-body">Forgot password?</a>
          </div>
          ...
          <div class="text-lg-start mt-4 pt-2">
            ...
            <button type="submit" name="btn_login" class="btn  btn-success btn-lg fw-bold text">Login </button>
            ...
            <p class="small fw-bold mt-2 pt-1 mb-0"> Don't have an account? <a href="register_student.php"
