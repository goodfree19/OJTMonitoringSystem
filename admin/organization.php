...
<?php include('../include/sidebar_admin.php');  if (isset($_POST['search_btn'])) {
    ...
    $items = "SELECT * FROM company_name WHERE supervisor_name LIKE '%$search_query%' OR company_name LIKE '%$search_query%'  ";
} else {
    $items = "SELECT * FROM company_name WHERE archive=0";
}
                        ...
                        <div id="page_top" class="section-body top_dark">
                            <div class="container-fluid">
                                <div class="page-header">
                                    <div class="left">
                                        <h1 class="page-title"><i class="fa fa-building text-success"></i> Supervisor</h1>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-md-flex justify-content-between mb-2">
                                        <ul class="nav nav-tabs b-none">
                                            <li class="nav-item"><a class="nav-link active" href=""><i class="fa fa-list-ul"> </i> Supervisor List</a>
                                            </li>
                            ...
                            <div class="row clearfix">
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="card">
                                        ...
                                        <table id="students" class="table app-table-hover mb-0 text-left">
                                                  ...
                                                  <?php  $role=$item['role'];
                                                   ...
                                                   ?>
                                                      ...
                                                      if($role==0||$role==1){ ?>
                                                        ...
                                                        <td class="text-right ">
                                                          <a href="supervisor_check.php?id=<?=$item['id']?>" class="btn btn-success">Check</a>  
                                                        </td><?php } else{ ?>
                                                            <td class="text-right ">
